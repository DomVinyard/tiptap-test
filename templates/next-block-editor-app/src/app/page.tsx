    ...
    <div className="max-w-4xl mx-auto py-12 px-4">
      <div className="mb-8">
        ...
        <p className="text-lg text-neutral-600 dark:text-neutral-400">
          A sandbox for exploring and testing new ideas around the Wordware editor. Each experiment represents different approaches and concepts that could shape the future of the platform.
        </p>
      </div>

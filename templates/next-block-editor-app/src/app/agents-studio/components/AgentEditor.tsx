...
export function AgentEditor({ isPreviewMode = false }: AgentEditorProps) {
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#EDF5FB] to-[#F2F7FA] p-8">
      <div className={cn(
        "max-w-[800px] mx-auto bg-white rounded-lg p-12 border border-slate-200 transition-all duration-500 ease-in-out",
        isPreviewMode 
          ? "scale-[0.75] opacity-90 origin-top delay-0" 
          : "scale-100 opacity-100 delay-[450ms]"
      )}>
